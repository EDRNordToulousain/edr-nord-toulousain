  ...
  return (
    <footer className="mt-20 bg-night text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 md:grid-cols-3">
        ...
        <div><h2 className="font-black uppercase tracking-wide">Suivez-nous</h2><SocialLinks theme="dark" className="mt-4" /><div className="mt-6 flex flex-wrap gap-4 text-sm"><Link href="/mentions-legales">Mentions légales</Link><Link href="/politique-de-confidentialite">Confidentialité</Link></div></div>
      </div>
