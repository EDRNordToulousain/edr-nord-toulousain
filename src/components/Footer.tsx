  ...
  return (
    <footer className="mt-20 bg-night text-white">
      <div className="mx-auto grid max-w-7xl gap-10 px-5 py-14 md:grid-cols-3">
        ...
        <div><h2 className="font-black uppercase tracking-wide">Liens utiles</h2><div className="mt-4 grid gap-2 text-sm text-white/70"><Link href="/categories">Les catégories</Link><Link href="/calendrier">Calendrier</Link><Link href="/evenements">Événements</Link><Link href="/partenaires">Partenaires</Link><Link href="/contact">Nous contacter</Link></div></div>
